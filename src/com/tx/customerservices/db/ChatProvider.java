...
public class ChatProvider extends ContentProvider {
	...
	public static final String AUTHORITY = "com.tx.customerservices.db.DoctorChats";
	public static final String TABLE_NAME = "doctorchats";
	...
	static {
		URI_MATCHER.addURI(AUTHORITY, "doctorchats", MESSAGES);
		URI_MATCHER.addURI(AUTHORITY, "doctorchats/#", MESSAGE_ID);
	}
	...
	private static class ChatDatabaseHelper extends SQLiteOpenHelper {
		...
		private static final String DATABASE_NAME = "doctorchat.db";
		...
		public void onCreate(SQLiteDatabase db) {
			infoLog("creating new doctorchat table");
			...
			db.execSQL("CREATE TABLE " + TABLE_NAME + " (" + ChatConstants._ID
					...
					+ ChatConstants.WHAT_NAME + " TEXT,"
					+ ChatConstants.DOCTOR_ID + " INTEGER,"
					+ ChatConstants.KUAIZHENG_ID + " INTEGER,"
					+ ChatConstants.TYPE_MESSAGE + " INTEGER,"
					+ ChatConstants.QUESTION_ID + " INTEGER,"
	...
	public static final class ChatConstants implements BaseColumns {
		...
		public static final String CONTENT_TYPE = "vnd.android.cursor.dir/vnd.yaxim.doctorchat";
		public static final String CONTENT_ITEM_TYPE = "vnd.android.cursor.item/vnd.yaxim.doctorchat";
